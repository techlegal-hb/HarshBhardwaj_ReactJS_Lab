...
import { getUniquePayeeNames } from "../services/expense_utils";
...
const ExpenseCreator = ({expenseItems, refreshParent} : ExpenseCreatorModel) => {
  ...
  return (
    ...
    <Button variant="primary" className="float-end custom-btn" onClick={handleShow}>Add</Button>
      ...
      <Modal.Body>
          ...
          <Form onSubmit={handleAddExpenseItem}>
            ...
            <Form.Group className="mb-3" controlId="expenseDescription">
              ...
              <Form.Control  required type="text" placeholder="Enter expense description" ref={expenseDescriptionRef} />
            </Form.Group>
            ...
            <Form.Group className="mb-3" controlId="price">
              ...
              <Form.Control  required type="number" placeholder="Enter price" ref={priceRef}/>
            </Form.Group>            

            <Form.Group className="mb-3" controlId="expenseDate">
              <Form.Label>Expense Date</Form.Label>
              <Form.Control  required type="date" ref={expenseDateRef}/>
            </Form.Group>            
